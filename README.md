...
4. [Реализация функции библиотеки matrix.h](#Реализация-функции-библиотеки-matrixh) 
5. [Установка для пользователя](#Установка-для-пользователя)
...
`make all` - Эта цель запускает цель `s21_matrix.a`

`make test` - Эта цель компилирует и запускает тестовый файл test.c, который,содержит набор тестов для библиотеки s21_matrix.a

`make s21_matrix.a` - Эта команда создает статическую библиотеку из исходных файлов
